...
/**
 * @file yarpVideoModuleModule.h
 * @brief Simple module as yarpVideoModule.
 */

#ifndef yarpVideoModule_H
#define yarpVideoModule_H


/**
 *
 * \defgroup icub_yarpVideoModuleThread icub_yarpVideoModuleThread
 ...
 *
 * - \c from \c icub_yarpVideoModule.ini \n
 *   specifies the configuration file
 *
 * - \c context \c icub_yarpVideoModule/conf \n
 *   specifies the sub-path from \c ICUB_ROOT/icub/app to the configuration file
 *
 * - \c name \c icub_interactionInterface \n
 *   specifies the name of the yarpVideoModuleThread (used to form the stem of yarpVideoModuleRateThread port names)
 *
 * - \c robot \c icub \n
 ...
 *    The port can be used by other yarpVideoModuleRateThreads but also interactively by a user through the yarp rpc directive, viz.: \c yarp \c rpc \c /yarpVideoModule
 ...
 *
 * \c interactionInterface.ini  in \c ICUB_ROOT/app/yarpVideoModule/conf \n
 *
 ...
 *
 * <tt>yarpVideoModule --name yarpVideoModule </tt>
 *
 * \author jonas gonzalez
 *
...
#define COMMAND_VOCAB_FPS                VOCAB3('f','p','s')
...
class yarpVideoModule:public yarp::os::RFModule {
    ...
    std::unique_ptr<yarpVideoRateThread> videoRateThread;             // pointer to a new thread to be created and started in configure() and stopped in close()

public:
    /**
    *  configure all the yarpVideoModuleModule parameters and return true if successful
